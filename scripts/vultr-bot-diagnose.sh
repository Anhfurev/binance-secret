...
source .env
set +a
for k in BOT_SECRET SUPABASE_URL NEXT_PUBLIC_SUPABASE_URL SUPABASE_SERVICE_ROLE_KEY BINANCE_REST_GATEWAY_URL BINANCE_GATEWAY_SECRET BINANCE_API_KEY BINANCE_API_SECRET TELEGRAM_BOT_TOKEN TELEGRAM_CHAT_ID; do
  v="${!k:-}"
